...
import { createOrder, getMyOrders, getOrderById, updateOrderStatus, createReturnRequest, createRazorpayOrder } from '../controllers/OrderController.js';
...
orderRoutes.post('/razorpay/create-order', requireAuth(['customer']), createRazorpayOrder);
